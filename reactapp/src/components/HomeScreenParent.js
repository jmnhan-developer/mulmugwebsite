        ...
        <div>
            ...
            <div style={{ marginLeft: 20, marginRight: 20 }}>
                ...
                <Row style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: 50, marginBottom: 30 }}>
                    <h5 style={{ color: '#1F8A9E', textAlign: 'center' }}>Prêt à encourager votre enfant à faire des exercices ?</h5>
                </Row>
                ...
                <Row style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: 50, marginBottom: 30 }}>
                    <h5 style={{ color: '#1F8A9E', textAlign: 'center' }}>Comment ça marche ?</h5>
                </Row>
                <Row>
                    <Col xs={12} md={6} style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-around' }}>
                ...
                <Row style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: 50, marginBottom: 30 }}>
                    <h5 style={{ color: '#1F8A9E', textAlign: 'center' }}>Une méthode progressive avec plus 100 milles exercices…</h5>
                </Row>
                <Row style={{ display: 'flex', flexDirection: 'row' }}>
                ...
                <Row style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: 50, marginBottom: 30 }}>
                    <h5 style={{ color: '#1F8A9E', textAlign: 'center' }}>Créer sa wishlist* !</h5>
                </Row>
                ...
                <Row style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: 50, marginBottom: 30 }}>
                    <h5 style={{ color: '#1F8A9E', textAlign: 'center' }}>Encouragez votre enfant pour son travail et ses efforts !</h5>
                </Row>
                ...
                <Row style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: 50, marginBottom: 30 }}>
                    <h5 style={{ color: '#1F8A9E', textAlign: 'center' }}>Pour revoir les notions pendant ses vacances, rien de mieux que des Cahiers de Vacances !</h5>
                </Row>
                ...
                <Row style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: 50, marginBottom: 30 }}>
                    <h5 style={{ color: '#1F8A9E', textAlign: 'center' }}>Nos partenaires!</h5>
                </Row>
                <Row>
                ...
                <Row style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: 50, marginBottom: 30 }}>
                    <h5 style={{ color: '#1F8A9E', textAlign: 'center' }}>Ce que les utilisateurs disent de Mulmug...</h5>
                </Row>
