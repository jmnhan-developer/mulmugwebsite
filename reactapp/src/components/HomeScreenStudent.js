        ...
        <div>
            ...
            <div style={{marginLeft: 20, marginRight: 20}}>
                ...
                <Row style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: 50, marginBottom: 30 }}>
                    <h5 style={{ color: '#1F8A9E', textAlign: 'center' }}>Prêts à apprendre et à gagner des points !</h5>
                </Row>
                ...
                <Row style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: 50, marginBottom: 30 }}>
                    <h5 style={{ color: '#1F8A9E', textAlign: 'center' }}>Apprends progressivement avec plus de 100 milles exercices...</h5>
                </Row>
                <Row style={{ display: 'flex', flexDirection: 'row' }}>
                ...
                <Row style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: 50, marginBottom: 30 }}>
                    <h5 style={{ color: '#1F8A9E', textAlign: 'center' }}>Crée ta wishlist* !</h5>
                </Row>
                ...
                <Row style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: 50, marginBottom: 30 }}>
                    <h5 style={{ color: '#1F8A9E', textAlign: 'center' }}>Jusqu'à 12 600 points gagnés par chapitre complété !</h5>
                </Row>
                <Row style={{ display: 'flex', flexDirection: 'row' }}>
                ...
                <Row style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: 50, marginBottom: 30 }}>
                    <h5 style={{ color: '#1F8A9E', textAlign: 'center' }}>Pour réviser pendant tes vacances, rien de mieux que des Cahiers de Vacances !</h5>
                </Row>
                <Row style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
