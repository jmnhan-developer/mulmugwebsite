...
function Homescreen() {
    ...
    return (
        <Container style={{ display: 'flex', flexDirection: 'column', backgroundImage: 'url(./hpbackground.png)', height: '120vh', backgroundPosition: 'center' }}>
            ...
            <Row style={{ display: 'flex', flexDirection:'row', justifyContent:'center'}}>
                <Col xs={6} md={4} style={{ display: 'flex', justifyContent:'center', padding:0, margin:5 }}>
                    <Link to="/StudentHomeScreen" style={{ width: 180, height:80, backgroundColor: '#FFC300', borderRadius: 10, outline: 'none', border: 'none', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textDecorationLine: 'none', color: "white", marginBottom:5 }}>
                        <h4 style={{ marginBottom: 1 }}>Je suis ELEVE</h4>
                        <p style={{ marginBottom: 1 }}>En savoir plus...</p>
                    </Link>
                </Col>
                <Col xs={6} md={4} style={{ display: 'flex', justifyContent:'center', padding:0, margin:5 }}>
                    <Link to="/ParentHomeScreen" style={{ width: 180, height:80, backgroundColor: '#00B2C3', borderRadius: 10, outline: 'none', border: 'none', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textDecorationLine: 'none', color: "white", marginBottom:5 }}>
